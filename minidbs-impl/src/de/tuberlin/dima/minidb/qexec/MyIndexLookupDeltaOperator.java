 ...
 */
public class MyIndexLookupDeltaOperator implements IndexLookupOperator {
    ...
    public MyIndexLookupDeltaOperator(BTreeIndex index, DataField startKey, DataField stopKey, boolean startKeyIncluded, boolean stopKeyIncluded) {
    ...
    public void open(DataTuple correlatedTuple) throws QueryExecutionException {
        ...
        try {
            indexIterator = index.lookupRids(startKey, stopKey, startKeyIncluded, stopKeyIncluded);
